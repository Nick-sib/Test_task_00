 ...
 * для фильтрации фильмов исплозуется ArrayList<Integer> ids в genres_for_filter
 *
 * **/
...
//загружаем данный из массива + формируем список для фильтрации
    ...
    public ArrayList<Integer> getSelectedIds(){
        if (Selected == -1) return null;
            else return genresList.get(Selected).ids;
    }
}
